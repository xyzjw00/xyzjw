 ...
 * [條款]
 * 沒有限制。
 * 可以自由修改、分享、商業用，以及版權宣告都可以自己選擇。
 * 作者一概不負責，但是會盡可能的處理缺陷。
 * 
 * @param <For CTB>
 * @text ＜CTB 相關＞
 * @desc 專為 CTB 和其它獨立行動的戰鬥系統所設計的項目。
 * 
 * @param reactionState
 * @text 執行後的狀態
 * @parent <For CTB>
 * @type state
 * @desc 執行技能後將指定狀態添加到配合者身上，可假設是延遲或不行動。
 * 
 * @param <Message>
 * @text ＜訊息＞
 * @desc 顯示在戰鬥訊息的相關項目。
 ...
 * @type text
 * @default 合作
 * @desc 設定合體技能的符號，你也可以在使用其它插件時應用這個值。
 *
 ...
 * @parent <Party Command>
 * @type switch
 * @desc 這個開關可以隱藏隊伍指令裡的合體技能。
 * 
 * @param hideMenuCommandSwitch
 * @text 隱藏主選單裡的合體技能開關
 * @parent <Party Command>
 * @type switch
 * @desc 這個開關可以隱藏主選單裡的合體技能。
 * 
 * @param <Cooperation>
 * @text ＜外部連攜＞
 * @desc 這個項目可以跟外部其它插件一起使用。
 * 
 ...
 * @desc 如果滿足條件，則禁止使用合體技。
 * "Subject"（主體）是指技能使用者，"a" 是指每個參與者。
 */
