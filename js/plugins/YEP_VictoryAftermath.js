...
//=============================================================================
 /*:
 * @plugindesc v1.07 戰鬥結束後顯示一個訊息視窗，而不是訊息框文字說明隊伍獲得什麼。
 ...
 * @parent ---EXP Window---
 * @desc 標記在戰鬥中“獲得多少 EXP“的文本。
 * @default 獲得經驗值
 *
 * @param Gained EXP Format
 * @parent ---EXP Window---
 * @desc 顯示在戰鬥中“獲得多少 EXP“的文本。
 * @default +%1
 *
 ...
 * @min 0
 * @max 31
 * @desc 勝利成果視窗中顯示的經驗值計量條顏色 1 中使用的面板顏色。
 * @default 30
 *
 ...
 * @min 0
 * @max 31
 * @desc 勝利成果視窗中顯示的經驗值計量條顏色 2 中使用的面板顏色。
 * @default 31
 *
 ...
 * @min 0
 * @max 31
 * @desc 當角色升級的時候顯示的經驗值計量條顏色 1 中使用的面板顏色。
 * @default 14
 *
 ...
 * @min 0
 * @max 31
 * @desc 當角色升級的時候顯示的經驗值計量條顏色 2 中使用的面板顏色。
 * @default 6
 *
 * @param Gauge Ticks
 * @parent ---EXP Window---
 * @type number
 * @min 0
 * @desc 在經驗值計量條填滿之前發生的刻度數。每個刻度是 4 幀。
 * @default 15
 *
 * @param Tick SE
 * @parent ---EXP Window---
 ...
 * ============================================================================
 *
 * 這個插件會換掉預設戰鬥系統中的勝利訊息，轉而顯示更多訊息視窗。 
 * 調整參數並更改設置以適合您的遊戲。
 *
 * ============================================================================
 * 勝利成果
 * ============================================================================
 *
 * 在參數中，有一個“Victory Order”參數。 
 * 此參數可讓您選擇 勝利成果 中的步驟順序。
 *
 * 預設順序如下：
 *           exp         顯示 經驗值 視窗。
 *           custom      顯示 任何自定義插件擴展。
 *           drops       顯示 掉落物 視窗。
 *
 * 如果您切換這些步驟的順序、添加步驟或從“勝利順序”插件中刪除步驟，勝利
 * 成果將與您所做的任何更改相對應。
 *
 * ============================================================================
 * 插件命令
 * ============================================================================
 *
 * 如果你想稍微改變勝利成果順序，你可以使用以下插件命令。
 *
 * 插件命令：
 *   DisableVictoryAftermath   - 禁用勝利成果順序以及跳過勝利成果音樂。
 *                               
 *   EnableVictoryAftermath    - 啟用勝利成果順序；如果它之前已被禁用。
 *                               
 *   DisableVictoryMusic       - 為了繼續維持當前的播放而禁用勝利成果音樂。
 *                              
 *   EnableVictoryMusic        - 啟用勝利成果音樂；如果它之前已被禁用。
 *                               
 *
 * ============================================================================
 * 更新日誌
