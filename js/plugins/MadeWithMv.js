/*:
 * 注意：圖片儲存在 img/system 文件夾中。
 *
 * @plugindesc 在進入標題畫面之前顯示“用 MV 製作”的啟動畫面 和/或 自定義啟動畫面。
 * @author Dan "Liquidize" Deptula
 *
 * @help 這個插件不提供插件命令。       正體中文化 by xyzjw
 *                                                 
 * @param Show Made With MV
 * @desc 啟用/禁用顯示“Made with MV”啟動畫面。
 * OFF - false     ON - true
 * 預設: ON
 * @default true
 *
 * @param Made with MV Image
 * @desc 顯示“Made with MV”時使用的圖片。
 * 預設: MadeWithMv
 * @default MadeWithMv
 * @require 1
 * @dir img/system/
 ...
 * @desc 啟用/禁用顯示“Made with MV(自製)”啟動畫面。
 * OFF - false     ON - true
 * 預設: OFF
 * @default false
 *
