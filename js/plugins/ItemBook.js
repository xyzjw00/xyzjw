 ...
 *
 * 插件指令：
 *   ItemBook open            # 打開 道具圖鑑 的畫面
 *   ItemBook add weapon 3    # 將 武器 #3 添加到 道具圖鑑 中
 *   ItemBook add armor 4     # 將 護甲 #4 添加到 道具圖鑑 中
 *   ItemBook remove armor 5  # 從 道具圖鑑 中移除 護甲 #5
 *   ItemBook remove item 6   # 從 道具圖鑑 中移除 道具 #6
 *   ItemBook complete        # 完成 道具圖鑑
 *   ItemBook clear           # 清除 道具圖鑑
 *
 * 道具（武器、盔甲）提示：
 *   <book:no>                # 此道具未出現在 道具圖鑑 中
 *
 *                                                  正體中文化 by xyzjw
 */
